<div>
    <x-form-card title="Cargar PDFs de Surge ITIG">

        {{-- input oculto --}}
        <input type="file" id="surgePdfInput" accept="application/pdf" wire:model="doc" hidden>
        ...
        <div class="d-flex flex-wrap gap-3">
            ...
            <div class="card document-card"
                ...
                onclick="document.getElementById('surgePdfInput').click()">
                ...
                <div class="card-footer" style="padding: 0.5rem; text-align: center; background-color: #f8f9fa;">
                    <span style="text-decoration: none; color: inherit;">Agregar PDF Surge</span>
                </div>
            </div>
            ...
            {{-- Gallery --}}
            <div wire:loading.remove wire:target="doc" class="d-flex flex-wrap gap-3">
                @foreach ($docsSurge as $d)
                    <div class="card document-card"
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center"
                            ...
                            <a class="btn btn-sm btn-outline-primary" href="{{ asset('storage' . $d->documento) }}"
                                target="_blank">
                                Ver
                            </a>
                ...
                @if ($docsSurge->count() === 0)
                    <div class="text-muted" style="align-self:center;">
                        No hay PDFs Surge cargados aún.
                    </div>
                @endif
            </div>
