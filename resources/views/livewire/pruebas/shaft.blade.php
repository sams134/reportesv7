                                        ...
                                        <td>
                                            <div class="input-group "><span class="input-group-text"
                                                ...
                                                <input class="form-control" type="number" step="0.001"
                                                    ...
                                                    aria-describedby="basic-addon1" wire:model.defer="ajustes.0.0.e1" />
                                    ...
                                    <tr>
                                        <td>
                                            <div class="input-group "><span class="input-group-text"
                                                ...
                                                <input class="form-control" type="number" step="0.001"
                                                    placeholder="medida [mm]" aria-label="Username"
                                                    aria-describedby="basic-addon1" wire:model.defer="ajustes.0.0.e2" />
                                        ...
                                        <div class="table-responsive scrollbar">
                                            <table class="table table-hover tolerancias" style="font-size: 12px">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle text-nowrap bg-soft-primary">Regimen Tolerancia</td>
                                                        <td>{{ $ajustes[0][0]['rod']['rodamiento']['eje_ball_tol'] }}</td>
                                                        </td>
                                                        <td class="align-middle text-nowrap bg-soft-primary">Tolerancia</td>
                                                        <td>{{ number_format($ajustes[0][0]['rod']['rodamiento']['eje_ball_min']*1000, 0)}}μm a 
                                                    ...
                                                    <tr>
                                                        ...
                                                        @php
                                                            ...
                                                            @endphp
                                                        <td class="{{($diff_min > $ajustes[0][0]['rod']['rodamiento']['eje_ball_min'] && 
                                                              $diff_min < $ajustes[0][0]['rod']['rodamiento']['eje_ball_max'])?'bg-soft-success':'bg-soft-danger'}}">
                                                        ...
                                                        @php
                                                            ...
                                                            @endphp
                                                        <td class="{{($diff > $ajustes[0][0]['rod']['rodamiento']['eje_ball_min'] && 
                                                              $diff < $ajustes[0][0]['rod']['rodamiento']['eje_ball_max'])?'bg-soft-success':'bg-soft-danger'}}">
                                                ...
                                                <div class="col-6">
                                                    @if (App\Http\Livewire\Pruebas\Ajustes::findDeviation($ajustes[0][0]) > 0.1)
                                                        <p class="w-100 text-start my-0">
                                                            ...
                                                            <span class="text-danger">Demasiada Conicidad (Re-ajustar)</span>
                                                        </p>
                                                    @endif
                                                    
                                                    @if (($diff_min + 0.01) > $ajustes[0][0]['rod']['rodamiento']['eje_ball_min'] &&
                                                    ($diff_min + 0.000) < $ajustes[0][0]['rod']['rodamiento']['eje_ball_min'])
                                                    <p class="w-100 text-start my-0">
                                                        <img src="{{ asset('img/warning.jpg') }}" alt=""
                                                            style="max-width: 15px" class="">
                                                        <span class="text-danger">Ajuste Holgado (Se sugiere pegamento)</span>
                                                    </p>
                                                     @endif
                                                     @if (($diff_min + 0.01) < $ajustes[0][0]['rod']['rodamiento']['eje_ball_min'])
                                                    <p class="w-100 text-start my-0">
                                                        <img src="{{ asset('img/alert.png') }}" alt=""
                                                            style="max-width: 15px" class="">
                                                        <span class="text-danger">Ajuste demasiado Holagado (Se sugiere metalizar)</span>
                                                    </p>
                                                     @endif
                                                     ...
                                                     <p class="w-100 text-start my-0">
                                                         <img src="{{ asset('img/alert.png') }}" alt=""
                                                             style="max-width: 15px" class="">
                                                         <span class="text-danger">Ajuste demasiado Apretado (Se sugiere lijar)</span>
                                                     </p>
                                                      @endif
                                                </div>
