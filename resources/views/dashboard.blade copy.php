                ...
                <div class="card-body z-index-1">
                    <div class="row g-2 h-100 align-items-end">
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span
                                        class="fas fa-cogs text-primary"></span></div>
                                <div class="flex-1"><a class="stretched-link" href="{{ route('motores.index') }}">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span
                                        class="fas fa-balance-scale-left text-warning"></span></div>
                                <div class="flex-1"><a class="stretched-link"
                                        href="{{ route('motors.indexJobs', 'balanceos') }}">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span
                                        class="fas fa-wind text-danger"></span></div>
                                <div class="flex-1"><a class="stretched-link"
                                        href="{{ route('motors.indexJobs', 'metalizados') }}">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span
                                        class="fas fa-record-vinyl text-info"></span></div>
                                <div class="flex-1"><a class="stretched-link"
                                        href="{{ route('motors.indexJobs', 'tornos') }}">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="d-flex position-relative">
                                <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span
                                        class="fas fa-laptop text-default"></span></div>
        ...
        <div class="col-xxl-3 col-md-6">
            <div class="card h-100">
                <div class="card-header d-flex flex-between-center">
                    <h5 class="mb-0">Tecnicos Trabajando</h5><a class="btn btn-link btn-sm px-0"
                        href="#!">Report<span class="fas fa-chevron-right ms-1 fs--2"> </span></a>
                </div>
                <div class="card-body">
                    <p class="fs--1 text-600">Vea que porcentaje de tecnicos tienen trabajo <br /> o vea reporte de
                        equipos trabajando</p>
                    ...
                    <div class="row g-3 justify-content-between">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-success w-100 fs--1" type="button"><span
                                    class="fas fa-video me-2"></span>Join meeting</button>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese las RPM"
                                        aria-label="RPM" aria-describedby="rpm-label" name="rpm">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="potencia-label">Potencia</span>
                                    <input type="text" class="form-control" placeholder="Ingrese la potencia"
                                        aria-label="Potencia" aria-describedby="potencia-label" name="potencia">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="volts-label">Volts</span>
                                    <input type="text" class="form-control" placeholder="Ingrese los volts"
                                        aria-label="Volts" aria-describedby="volts-label" name="volts">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese los amps"
                                        aria-label="Amps" aria-describedby="amps-label" name="amps">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese el frame"
                                        aria-label="Frame" aria-describedby="frame-label" name="frame">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese el HAC"
                                        aria-label="HAC" aria-describedby="hac-label" name="hac">
                                </div>
                            </div>
                        </div>
                    </div>
