      ...
      <div class="navbar-vertical-content scrollbar">
        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
          ...
          <li class="nav-item">
            ...
            <!-- parent pages--><a class="nav-link" href="{{route('clientes.index')}}" role="button" aria-expanded="false">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-hat-cowboy-side"></span></span><span class="nav-link-text ps-1">Clientes</span>
                </div>
              </a>
            ...
            <!-- parent pages--><a class="nav-link" href="{{route('motores.index')}}" role="button" aria-expanded="false">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-globe"></span></span><span class="nav-link-text ps-1">Ver Motores</span>
                </div>
              </a> 
          ...
          <li class="nav-item">
            ...
            <!-- parent pages--><a class="nav-link" href="#" role="button" aria-expanded="false"">
              <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-horse"></span></span><span class="nav-link-text ps-1">Calibre de Cable</span>
              </div>
            </a>
