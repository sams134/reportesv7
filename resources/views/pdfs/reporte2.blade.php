...
<body>
    @php
        ...
        $pageCount = 2;
    @endphp
    <div style="position: absolute;top:{{ $page1 + 0 }}px;width:98%;height:1330px;border:3px solid #333; margin-left: 20px;">
        ...
        <div style="position: relative;width:100%;text-align:center;">
            ...
            <img src="{{ public_path('storage' . $foto_final->foto) }}" alt="Imagen de Entrada"
                style="position: relative;max-width: 80%; border-radius: 4px;max-height: 470px;">
        </div>
    ...
    {{-- pagina 2 --}}
    <div style="position: absolute;top:{{ $page2 + 0 }}px;width:98%;height:1325px;border:3px solid #333">
   ...
   @for($i=0;$i<$fotos->count();$i++)
        ...
        <div style="position: absolute;top:{{ $page2 * ($pageCount + ( intdiv($i,2))) + 0 }}px;width:100%;height:1327px;border:3px solid #333">
            <div style="position: relative; width:100%;background:#000044;height:25px;"></div>
            <div style="position: relative; width:100%;background:#550000;height:25px;"></div>
            <table class="cajilla" style="width: 100%;border-collapse: collapse;">
                <tr>
