<x-app-layout>
    ...
    <div class="card" id="runningProjectTable" data-list='{"valueNames":["projects","worked","time","date"]}'>
        ...
        <div class="card-body p-0">
          <div class="scrollbar">
            <table class="table mb-0 table-borderless fs--2 border-200 overflow-hidden table-running-project table-hover">
              ...
              <tbody class="list">
                    ...
                    <div class="d-flex align-items-center position-relative">
                     {{--   --}}
                      <div class="flex-1 ms-1">
                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="">{{$motor->fullOs}}</a></h6>
                  ...
                  <td>
                    ...
                    <div class="avatar avatar-xl">
                        ...
                        <img src="{{asset($tecnico->foto)}}" alt="" class="rounded-circle">
                  ...
                  <td class="text-end">
                    <div>
                      ...
                      <button class="btn p-0 ms-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar"><span class="text-500 fas fa-trash-alt"></span></button>
                    </div>
                  </td>
