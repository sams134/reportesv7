        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-info me-1 mb-1" type="button" href="{{route('clientes.edit',$cliente)}}">Editar Cliente
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <tr class="hover-actions-trigger">
                                    ...
                                    <td>
                                        <div class="d-inline-flex">
                                            <button class="btn btn-danger me-1 mb-1" type="button" onclick="deleteContact({{$contacto->id}})">
