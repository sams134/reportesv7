<div>
        ...
        <div class="col-12 ">
            <x-form-card title="Informacion de Cliente">
                <div class="mb-3">
                    ...
                    <input class="form-control"  type="text" placeholder="Nombre Cliente" wire:model.defer="cliente"/>
                ...
                <div class="mb-3">
                    ...
                    <div class="btn btn-falcon-default  mb-2 float-end" wire:click="setName">Usar Nombre Cliente</div>
                    <div class="btn btn-falcon-default me-2 mb-2 float-end" wire:click="setNameSA">Usar Nombre Cliente + S.A.</div>
                    <input class="form-control"  type="text" placeholder="Cliente S.A." wire:model.defer="razon_social"/>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control"  type="text" placeholder="Nit" wire:model.defer="nit"/>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control"  type="text" placeholder="Direccion Fiscal" wire:model.defer="direccion_fiscal"/>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control"  type="text" placeholder="Direccion Planta" wire:model.defer="direccion_planta"/>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="Pais">Pais</label>
                    <input class="form-control" type="text" value="Guatemala" wire:model.defer="pais"/>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="ciudad">Ciudad</label>
                    <input class="form-control" type="text" value="Guatemala" wire:model.defer="ciudad"/>
                </div>
                <div class=" mb-3">
                    ...
                    @forelse($contactos as $key=>$contacto)
                        <div class="col-12 col-lg-6">
                            <x-form-card title="Contacto {{$key+1}}">
                               ...
                               <input type="hidden" wire:model.defer="contactos.{{$key}}.id">
                                <div class="mb-3" wire:key="contactos_{{$key}}">
                                    <label class="form-label" for="InfoCliente">Nombre del Contacto</label>
                                    <input class="form-control"  type="text"  wire:model.defer="contactos.{{$key}}.name"/>
                                </div>
                                <div class="mb-3">
    ...
    <div class="bg-light clearfix px-2 py-1">
        ...
        <button type="button" class="btn btn-warning float-end m-2" wire:click="updateCustomer">Guardar Cliente</button>
