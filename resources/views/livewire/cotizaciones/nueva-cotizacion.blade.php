<div>
                        ...
                        @forelse($pdfsAntesItems as $pdf)
                            <div class="list-group-item d-flex align-items-center justify-content-between mb-2 border rounded"
                                ...
                                <button type="button" class="btn btn-sm btn-outline-danger"
                                    wire:click="confirmarEliminarPdfAdjuntoCotizacion('antes_items', '{{ $pdf['uuid'] }}')"
                                    wire:loading.attr="disabled" title="Eliminar PDF">
    ...
    {{-- aqui iba el modal de opciones para generar el pdf, ahora en 
   resources/views/livewire/cotizaciones/partials/opciones-pdf-cotizacion.blade.php
    --}}
